<template>
  <div :style='{"width":"100%","padding":"30px 7% 40px","margin":"0px auto","position":"relative","background":"#edeff1"}'>
    ...
    <div class="section-title"
      :style='{"padding":"12px 0 0","margin":"0px auto","color":"#333","textAlign":"center","background":"none","width":"100%","fontSize":"24px","fontWeight":"600","height":"60px"}'>
      My Addresses
    </div>
    ...
    <el-table :data="tableData" style="width: 100%">
      <el-table-column label="Contact" prop="name" width="100"></el-table-column>
      <el-table-column label="Phone" prop="phone" width="120"></el-table-column>
      <el-table-column label="Address" prop="address"></el-table-column>
      <el-table-column label="Default" prop="isdefault" width="80">
        <template slot-scope="scope">
          <el-tag :type="scope.row.isdefault === '是' ? 'primary' : 'success'" size="medium">
            {{ scope.row.isdefault === '是' ? 'Yes' : 'No' }}
          </el-tag>
        </template>
      </el-table-column>
  ...
  methods: {
    ...
    getAddr(page) {
      this.$http.get('address/list', {
        params: { page, limit: this.pageSize, userid: localStorage.getItem('frontUserid') }
      }).then(res => {
        if (res.data.code == 0) {
    ...
    handleDelete(index, row) {
      this.$confirm('Delete this address?', 'Confirm', {
